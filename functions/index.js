...
exports.apiNotifyMatchCreated = functions.https.onRequest(async (req, res) => {
    // เปิดสิทธิ์ CORS ให้หน้าเว็บเรียกใช้ได้
    ...
    try {
        ...
        return res.status(200).send("ส่งการ์ดแจ้งเตือนเข้าไลน์กลุ่มสำเร็จ");
    } catch (error) {
...
/**
 * ⏰ ฟังก์ชันที่ 2: ตั้งเวลาปลุก 15 นาที เพื่อเช็กยอด 2 ชั่วโมง (ตัวเดิม ผ่านแล้ว)
 */
